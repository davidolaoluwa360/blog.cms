        ...
        <div class="card-body">
            <form method="POST" action="{{route("posts.update", ["post" => $post->id])}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" cols="5" rows="5">{{$post->description}}</textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="published_at" value="{{isset($post->published_at) ? $post->published_at : ''}}" id="published_at" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="file" name="image" value="{{$post->image}}" id="image" class="form-control">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="category" id="category" class="form-control">
                        @foreach($categories as $category)
                            <option value="{{$category->id}}" {{$post_category_id == $category->id ? "selected" : ""}}>{{$category->name}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="tag[]" id="tag" class="form-control tags-selector" multiple="multiple">
                        @foreach($tags as $tag)
                            <option value="{{$tag->id}}"
